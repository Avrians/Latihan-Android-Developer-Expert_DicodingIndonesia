...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class GsonLibraryAccessors extends SubDependencyFactory {
        private final GsonConverterLibraryAccessors laccForGsonConverterLibraryAccessors = new GsonConverterLibraryAccessors(owner);

        public GsonLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>gson.converter</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GsonConverterLibraryAccessors getConverter() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGsonConverterLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GsonConverterLibraryAccessors extends SubDependencyFactory {

        public GsonConverterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>factory</b> with <b>com.squareup.retrofit2:converter-gson</b> coordinates and
         * with version reference <b>retrofit</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getFactory() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("gson.converter.factory");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hiltPlugin</b> with value <b>2.51.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NavigationSafePluginAccessors extends PluginFactory {
        ...
        /**
         * Group of plugins at <b>plugins.navigation.safe.args</b>
         */
        public NavigationSafeArgsPluginAccessors getArgs() {
    ...
    public static class NavigationSafeArgsPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>navigation.safe.args.kotlin</b> with plugin id <b>androidx.navigation.safeargs.kotlin</b> and
         * with version reference <b>nav</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKotlin() { return createPlugin("navigation.safe.args.kotlin"); }
