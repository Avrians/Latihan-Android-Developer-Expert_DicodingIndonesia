package com.avrians.core.data.source.local

import androidx.lifecycle.LiveData
import com.avrians.core.data.source.local.entity.TourismEntity
import com.avrians.core.data.source.local.room.TourismDao
import kotlinx.coroutines.flow.Flow

class LocalDataSource(private val tourismDao: TourismDao) {

    companion object {
        private var instance: com.avrians.core.data.source.local.LocalDataSource? = null
